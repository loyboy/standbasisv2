...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="row border border-default">         
            ...
            <div class="bg-primary text-center p-2 col-md-12">
                <p class="lead text-white">Standbasis Report for All Teacher's Lessonnote Performance</p>
                <br>
  ...
  <table id = "mytable">
    ...
    <tbody>
        ...
        <?php  if(session()->has('searchdata.sd')) { ?>
            <td style=" text-align: center; "> <?php echo SubjectController::getSubjectLessonnoteTeacher($t->tea_id, $t->class_id, $s['id'],session('searchdata.sd'), session('searchdata.ed'), session('searchdata.tr')); ?> </td>

            <?php } else {  ?>

                <td style=" text-align: center; "> <?php echo SubjectController::getSubjectLessonnoteTeacher($t->tea_id, $t->class_id, $s['id']); ?> </td>
